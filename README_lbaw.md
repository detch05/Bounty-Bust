...
> **Note on Composer installation (FEUP lab machines)**
>
> On FEUP classroom computers, **Composer is not installed globally**, and **administrator privileges (`sudo`) are not available**.  
> This is **not a problem** — Composer can be used **locally within your project folder**, without requiring installation system-wide.  
> In that case, you can run Composer with: `php composer.phar install`

                ...
                <div class="p-4">
                                ...
                                <div class="mt-3 pt-2 border-top d-flex justify-content-between align-items-center small text-muted">
                                    ...
                                    <div>
                                        @if ($answer->is_correct)
                                            <span class="badge bg-success ms-3"><i class="bi bi-check-circle-fill"></i> Resposta Aceite</span>
                                        @endif
                                        <i class="bi bi-calendar"></i>
                                        {{ $answer->content->date }}
                                    </div>
                    ...
                    <form action="{{ route('answers.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            {{-- O campo 'description' aqui corresponde ao campo de conteúdo (media/description) que definiste --}}

...
class TagsController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Acrescenta contadores e aplica ordenação consoante filtro 'sort'
        ...
        if ($sort === 'popularity') {
            $tagsQuery->orderBy('followersCount', 'desc');
        } elseif ($sort === 'bounties') {
            $tagsQuery->orderBy('bountiesCount', 'desc');
        } else {
        ...
        $tags = $tagsQuery->paginate(10)->appends($request->query());
